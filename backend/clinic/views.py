...
from .serializers import RegisterSerializer, UserSerializer,DepartmentSerializer,DoctorListSerializer,AppointmentCreateSerializer,AppointmentSerializer,QueueStatusSerializer
